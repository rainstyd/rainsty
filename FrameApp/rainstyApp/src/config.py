...
def get_secret_key():
    s = """
        I love her, Rainsty love her, Tis all that I can say;
        It is my vision in the night, My dreaming in the sunny day.
    """
...
class AppConfig(object):
    ...
    logger = Logger(base_path, log_dir_name, log_file_name)
