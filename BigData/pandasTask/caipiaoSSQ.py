...
def main():
    ...
    print(df[:20])
    # print(df.loc[:, 'one'].value_counts()[:3])
    # print(df.loc[:, 'two'].value_counts()[:3])
    # print(df.loc[:, 'thr'].value_counts()[:3])
    # print(df.loc[:, 'fou'].value_counts()[:3])
    # print(df.loc[:, 'fiv'].value_counts()[:3])
    # print(df.loc[:, 'six'].value_counts()[:3])
    print(df[:10].loc[:, 'sev'].value_counts())
    print(df[10:20].loc[:, 'sev'].value_counts())
    print(df[20:30].loc[:, 'sev'].value_counts())
    # print(df.shape)
    # print(df.info())
    # print(df.dtypes)
    # print(df['six'].dtype)
